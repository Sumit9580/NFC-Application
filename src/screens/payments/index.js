import { Switch, Animated, Text, View, ImageBackground, Dimensions, TouchableOpacity, Image, TextInput, ScrollView, StyleSheet,BackHandler } from 'react-native'
    ...
    render() {
        return (
            <View style={{ flex: 1, backgroundColor: "#ffffff" }}>
                <TouchableOpacity onPress={() => this.handleBack()} style={styles.arrowview}>
